...
#        else:
#            itr-=1
#    draw.text((227,136),textadd,(39,33,37),font=font)
#    textadd = ''.join(random.choice(string.ascii_uppercase+ " ") for _ in range(random.randint(5,20)))
#    for itr in range(random.randint(1,3)):
#        ins_pos=random.randint(0,len(textadd)-2)
#        if textadd[ins_pos]!=" ":
...
#            itr-=1
#    textadd = ''.join(random.choice(string.ascii_uppercase + string.digits+" ") for _ in range(random.randint(5,20)))
#    draw.text((227,243),textadd,(39,33,37),font=font)
#    for itr in range(random.randint(1,3)):
#        ins_pos=random.randint(0,len(textadd)-2)
#        if textadd[ins_pos]!=" ":
#            textadd=textadd[:ins_pos]+" "+textadd[ins_pos:]
...
#            itr-=1
#    textadd = ''.join(random.choice(string.ascii_uppercase  + string.digits+" ") for _ in range(random.randint(5,20)))
#    draw.text((227,271),textadd,(39,33,37),font=font)
#    for itr in range(random.randint(1,3)):
#        ins_pos=random.randint(0,len(textadd)-2)
#        if textadd[ins_pos]!=" ":
#            textadd=textadd[:ins_pos]+" "+textadd[ins_pos:]
...
#            itr-=1
#    textadd = ''.join(random.choice(string.ascii_uppercase + string.digits+" ") for _ in range(random.randint(5,20)))
#    draw.text((227,299),textadd,(39,33,37),font=font)
#    title="out"+str(i)+'.jpg'
...
#    draw.text((228,102),textadd,(227,70,81),font=fontlab)
